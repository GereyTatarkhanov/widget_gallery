...
class OutlineInputBorderWithNormalizedLabel extends InputBorder {
  ...
  ///    drawn.
  const OutlineInputBorderWithNormalizedLabel({
  ...
  @override
  OutlineInputBorderWithNormalizedLabel copyWith({
    BorderSide? borderSide,
    BorderRadius? borderRadius,
  }) {
    return OutlineInputBorderWithNormalizedLabel(
  ...
  @override
  OutlineInputBorderWithNormalizedLabel scale(double t) {
    return OutlineInputBorderWithNormalizedLabel(
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is OutlineInputBorderWithNormalizedLabel) {
      final OutlineInputBorderWithNormalizedLabel outline = a;
      return OutlineInputBorderWithNormalizedLabel(
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is OutlineInputBorderWithNormalizedLabel) {
      final OutlineInputBorderWithNormalizedLabel outline = b;
      return OutlineInputBorderWithNormalizedLabel(
  ...
  bool operator ==(Object other) {
    ...
    return other is OutlineInputBorderWithNormalizedLabel &&
